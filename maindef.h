...
typedef enum {
	...
	C_UPDATE       = 5,	//!< For JASON file updates 
...
typedef enum {
	...
	S_TEXT					= 36,	    //!< text device Paramerter : devicename;min;max (min und max sind freiwillig)
	S_GAS					= 37,	//!< Gas meter, V_FLOW, V_VOLUME
	S_GPS					= 38,	//!< GPS Sensor, V_POSITION
	S_WATER_QUALITY			= 39,	//!< V_TEMP, V_PH, V_ORP, V_EC, V_STATUS
	S_NUMBER				= 40,	    //!< For any use of numeric values input/output Paramerter : devicename;min;max (min und max sind freiwillig)
